...
class Parent extends React.Component {
  state = {
    persons: [
      { id : 1, name: "Foo", age: 29 },
      { id :2, name: "Bar", age: 30 },
      { id: 3, name: "Baz", age: 31 },
    ],
  };
  ...
  render() {
    ...
    return (
      <>
        ...
        {/* <Child username={this.state.persons[0].name} age={this.state.persons[0].age} />
            <Child username={this.state.persons[1].name} age={this.state.persons[1].age} />
            <Child username={this.state.persons[2].name} age={this.state.persons[2].age} /> */}
      </>
    );
  }
}
